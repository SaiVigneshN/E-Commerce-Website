...
/// end getRealIpUser functions ///

/// start add_cart functions ///
...
function add_cart(){
    ...
    if(isset($_GET['add_cart'])){
        ...
        if(mysqli_num_rows($run_check)>0){
            ...
            echo "<script>windows.open('details.php?pro_id=$p_id','_self')</script>";
...
function getPCats(){
    ...
    $get_p_cats = "select * from product_categoies";
...
function getpcatpro(){
    ...
    if(isset($_GET['p_cat'])){
        ...
        $get_p_cat ="select * from product_categoies where p_cat_id='$p_cat_id'";
